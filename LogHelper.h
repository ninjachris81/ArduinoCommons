...
#ifdef LOG_PREFIX
  #define LOG_PRINTF(msg, format) LOG_SERIAL_DEV.print(LOG_PREFIX); LOG_SERIAL_DEV.println(msg, format)
  #define LOG_PRINTLNF(msg, format) LOG_SERIAL_DEV.print(LOG_PREFIX); LOG_SERIAL_DEV.println(msg, format)
#else
  #define LOG_PRINTF(msg, format) LOG_SERIAL_DEV.println(msg, format)
